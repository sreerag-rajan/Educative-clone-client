...
export const Part2 = ()=>{
    return(
        <div className="part2">
            ...
            <iframe width={"90%"} height={"700px"} src="https://player.vimeo.com/video/494436751?autoplay=1&loop=1&title=0&byline=0&portrait=0&muted=1&quality=720p" frameBorder="0"></iframe>
            <img src={multiplelanguageIcons} alt="" />
        </div>
    )
}
