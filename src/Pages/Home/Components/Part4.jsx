        ...
        <div>
            ...
            <div className="flex">
                ...
                <div className="reviews">
                    {reviews.map((el,i)=>{
                        return <div key={i}>
                        <svg width="24" height="18" viewBox="0 0 24 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-A400 dark:text-gray-600 fill-current"><path d="M24 7.3h-5.1L22.3.4H17l-3.4 6.9v10.3H24V7.3zM10.3 17.6V7.3H5L8.6.4H3.4L0 7.3v10.3h10.3z" fill="current"></path></svg>
                        <p>{el.review}</p>
                        <h3>{el.author}</h3>
                        <p>{el.handle}</p>
                    </div>
